...
rpcProviders.ChainRpcProviders.getSolanaRpcProviderByChainId = (config, chainId) => {
    var _a;
    const rpcProviders$1 = rpcProviders.ChainRpcProviders.getProviders(config);
    const provider = (_a = rpcProviders$1['solana']) === null || _a === void 0 ? void 0 : _a.find((rpcProvider) => rpcProvider.chainId === chainId);
    return provider;
};
