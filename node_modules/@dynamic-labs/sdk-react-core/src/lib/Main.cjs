...
require('./context/ConnectWithEmailOtpContext/connectWithEmailOtpContext.cjs');
require('./context/ConnectWithEmailOtpContext/constants.cjs');
...
const Main = () => {
    ...
    React.useEffect(() => {
        const newToWeb3WalletKey = localStorage.LocalStorage.getFromLS(localStorage$1.NEWTOWEB3_WALLET_EXTENSION_FLAG_KEY);
