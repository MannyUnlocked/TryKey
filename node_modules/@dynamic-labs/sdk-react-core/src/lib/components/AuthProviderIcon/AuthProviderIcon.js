...
const AuthProviderIcon = ({ jwt, iconSize = 64, showStatus, wallet, }) => {
    ...
    if (!walletForIcon) {
        if (isLoadingEmbeddedWallet) {
            return (jsx(WalletIconWithNetwork, { iconSize: iconSize, Icon: SvgEmbeddedWalletIcon, chainName: 'eip155', showNetwork: false }));
        }
        return null;
    }
    ...
    if (isEmbeddedWallet && MagicEmailOrSocialIcon) {
        ...
        return (jsx(WalletIconWithNetwork, { iconSize: iconSize, Icon: MagicEmailOrSocialIcon, chainName: chainEnum, showNetwork: showStatus }));
    }
