...
const ErrorContainer = ({ children, className, isMultiWalletError = false, withIcon = true, variant = 'error', copykey, }) => {
    ...
    return (jsxRuntime.jsxs("div", { className: effectiveContainerClassName, "data-testid": 'error-container', children: [withIcon && jsxRuntime.jsx(error.ReactComponent, {}), jsxRuntime.jsx(Typography.Typography, { variant: 'body_small', className: effectiveErrorClassName, copykey: copykey, children: children })] }));
};
