...
const ErrorContainer = ({ children, className, isMultiWalletError = false, withIcon = true, variant = 'error', copykey, }) => {
    ...
    return (jsxs("div", { className: effectiveContainerClassName, "data-testid": 'error-container', children: [withIcon && jsx(SvgError, {}), jsx(Typography, { variant: 'body_small', className: effectiveErrorClassName, copykey: copykey, children: children })] }));
};
