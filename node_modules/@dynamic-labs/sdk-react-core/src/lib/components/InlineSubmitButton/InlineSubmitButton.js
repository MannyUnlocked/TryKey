...
const InlineSubmitButton = ({ disabled, highlighted, isFocused, isHovered, className, style, }) => {
    var _a;
    const { projectSettings } = useInternalDynamicContext();
    if (!((_a = projectSettings === null || projectSettings === void 0 ? void 0 : projectSettings.design.modal) === null || _a === void 0 ? void 0 : _a.emailSubmitButtonInsideInput))
        return null;
    return (jsx(IconButton, { "data-testid": 'submit_button', type: 'submit', className: classNames('inline-submit-button', className, {
