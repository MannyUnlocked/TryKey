...
type RetryPhoneParams = {
    /** Non formatted phone number without country code */
    phone: string;
    /** Country iso2, such as "US", "FR" or "BR" */
    iso2: string;
    /** Country code, such as "1", "33" or "55" */
    dialCode: string;
};
type RetryData = RetryPhoneParams;
