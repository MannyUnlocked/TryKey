...
const linkWallet = (environmentId, { messageToSign, network, signedMessage, publicWalletAddress, chain, walletName, walletProvider, additionalWalletAddresses, backup, password, passwordSource, }, userJwt) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
...
const verifyWallet = (environmentId, { messageToSign, signedMessage, publicWalletAddress, chain, walletName, walletProvider, captchaToken, network, oauth, additionalWalletAddresses, }) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
    const verifyRequest = sdkApi$1.VerifyRequestFromJSON({
        additionalWalletAddresses,
        captchaToken,
        chain,
...
const signInOAuth = (environmentId, providerType, { code, codeVerifier, state, captchaToken }) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (data.error.code === 'missing_from_list') {
            throw new utils.NoAccessError({
                walletPublicKey: (_b = data === null || data === void 0 ? void 0 : data.payload) === null || _b === void 0 ? void 0 : _b.walletPublicKey,
            });
        }
        if (data.code === 'email_associated_with_different_provider') {
            throw new utils.AccountExistsError(data.error, data.payload);
...
const createTurnkeyEmbeddedWallet = ({ attestation, challenge, environmentId, userJwt, chains = [sdkApi$1.ChainEnum.Evm], }) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
...
const initEmbeddedWalletSession = ({ authenticatorType, walletId, publicKey, environmentId, userJwt, }) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
...
const updateUserPasskey = ({ userJwt, environmentId, id, alias, }) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
    try {
...
const exportEmbeddedWallet = ({ userJwt, environmentId, walletId, activityId, }) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getWalletAuthToken = ({ environmentId, type, }, userJwt) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const authToken = yield sdkApi(userJwt).getAuthToken({
            environmentId,
            type,
        });
...
const getEmbeddedWalletBackup = ({ environmentId, }, userJwt) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield sdkApi(userJwt).getEmbeddedWalletBackups({
            environmentId,
        });
...
const getEmbeddedWalletPasscode = ({ environmentId, }, userJwt) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield sdkApi(userJwt).getEmbeddedWalletPasscode({
            environmentId,
        });
        return response.secret;
    }
...
const claimEmbeddedWallet = ({ environmentId, walletId, }, userJwt) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield sdkApi(userJwt).claimEmbeddedWallet({
        ...
        return handleVerifyResponseError(e);
    }
});
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const handleVerifyResponseError = (e) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
    var _c, _d;
    logger.logger.error(e);
    // request failed, return unknown error
    const data = yield ((_c = e === null || e === void 0 ? void 0 : e.json) === null || _c === void 0 ? void 0 : _c.call(e));
    if (!((_d = data === null || data === void 0 ? void 0 : data.error) === null || _d === void 0 ? void 0 : _d.code)) {
...
// SMS VERIFICATION
// ==================================================
const createSmsVerification = ({ isoCountryCode, phoneNumber, phoneCountryCode, environmentId, captchaToken, }) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
    try {
...
const signInWithSmsVerification = ({ verificationToken, verificationUUID, environmentId, captchaToken, }) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
    try {
...
const retrySmsVerification = ({ isoCountryCode, phoneCountryCode, phoneNumber, environmentId, verificationUUID, }) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
    try {
...
const verifySms = ({ verificationToken, verificationUUID, environmentId, }, userJwt) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield sdkApi(userJwt).verifySmsVerification({
            environmentId,
            smsVerificationVerifyRequest: {
                verificationToken,
                verificationUUID,
