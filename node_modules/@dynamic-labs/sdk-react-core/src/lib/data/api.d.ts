import { ProjectSettings, UserFields, ChainEnum, UpdateSelfResponse, WalletProviderEnum, AuthModeEnum, EmailVerificationCreateResponse, VerifyResponse, OauthRequest, OauthResultRequest, ProviderEnum, OnrampConfiguration, EmailProviderResponse, OauthResultResponse, PasskeyRegistrationCredential, ExportEmbeddedWalletResponse, EmbeddedWalletAuthType, SmsVerificationCreateResponse, FarcasterSignInRequest } from '@dynamic-labs/sdk-api';
...
export declare const linkWallet: (environmentId: string, { messageToSign, network, signedMessage, publicWalletAddress, chain, walletName, walletProvider, additionalWalletAddresses, backup, password, passwordSource, }: VerifyWallet, userJwt: string) => Promise<string | undefined>;
...
export declare const verifyWallet: (environmentId: string, { messageToSign, signedMessage, publicWalletAddress, chain, walletName, walletProvider, captchaToken, network, oauth, additionalWalletAddresses, }: VerifyWallet) => Promise<string | undefined>;
...
export declare const createTurnkeyEmbeddedWallet: ({ attestation, challenge, environmentId, userJwt, chains, }: CreateTurnkeyEmbeddedWalletProps) => Promise<VerifyResponse>;
...
export declare const initEmbeddedWalletSession: ({ authenticatorType, walletId, publicKey, environmentId, userJwt, }: InitPasskeyRecoveryProps) => Promise<import("@dynamic-labs/sdk-api").InitPasskeyRecoveryResponse | import("@dynamic-labs/sdk-api").InitEmailAuthResponse>;
...
export declare const updateUserPasskey: ({ userJwt, environmentId, id, alias, }: updateUserPasskeysProps) => Promise<import("@dynamic-labs/sdk-api").UserPasskey | undefined>;
export declare const exportEmbeddedWallet: ({ userJwt, environmentId, walletId, activityId, }: {
    userJwt: string;
    environmentId: string;
    walletId: string;
    activityId: string;
...
export declare const claimEmbeddedWallet: ({ environmentId, walletId, }: {
    environmentId: string;
    walletId: string;
}, userJwt: string) => Promise<VerifyResponse | {
    code: string;
}>;
...
export declare const signInWithSmsVerification: ({ verificationToken, verificationUUID, environmentId, captchaToken, }: {
    environmentId: string;
    verificationToken: string;
    verificationUUID: string;
    captchaToken?: string | undefined;
...
export declare const farcasterSignIn: (environmentId: string, farcasterSignInRequest: FarcasterSignInRequest) => Promise<string | undefined>;
