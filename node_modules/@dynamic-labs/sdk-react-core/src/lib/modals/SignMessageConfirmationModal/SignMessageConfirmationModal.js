...
const SignMessageConfirmationModal = ({ appLogoUrl, appName, appOrigin, message, handler, onReject, onSignMessage, }) => {
    ...
    const handleMessageSign = () => __awaiter(void 0, void 0, void 0, function* () {
