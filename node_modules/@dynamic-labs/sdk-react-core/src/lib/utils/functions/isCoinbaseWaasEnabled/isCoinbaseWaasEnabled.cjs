...
const isCoinbaseWaasEnabled = (projectSettings) => {
    var _a;
    return isProviderEnabled.isProviderEnabled((_a = projectSettings === null || projectSettings === void 0 ? void 0 : projectSettings.providers) !== null && _a !== void 0 ? _a : [], sdkApi.ProviderEnum.CoinbaseWaas);
};
