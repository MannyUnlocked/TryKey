...
import { ProviderEnum, OauthResultStatus } from '@dynamic-labs/sdk-api';
import { SocialOAuthErrorCode } from '@dynamic-labs/types';
import { isMobile, NoAccessError, AccountExistsError, SocialAccountAlreadyExistsError } from '@dynamic-labs/utils';
...
import 'viem';
import 'viem/chains';
import { getOAuthResult, signInOAuth, farcasterSignIn, verifyOAuth } from '../../../data/api.js';
...
import { connect, watchStatus } from './farcaster.js';
import 'yup';
...
const useSocialAuth = ({ sessionTimeout, authMode, onSettled, onError, }) => {
    var _a;
    const { environmentId, onboardingOnlyJwt, setOnboardingOnlyJwt, setCallback, setShowAuthFlow, setIsVerificationInProgress, projectSettings, consumeNonce, } = useInternalDynamicContext();
    ...
    const connectWithFarcaster = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (!(data === null || data === void 0 ? void 0 : data.url) || !(data === null || data === void 0 ? void 0 : data.channelToken)) {
            handleError(SocialOAuthErrorCode.GENERAL_ERROR, "Farcaster didn't return a valid url.");
            return;
        }
        ...
        if (status === 'timeout' ||
            ...
            handleError(SocialOAuthErrorCode.GENERAL_ERROR, "Farcaster didn't return valid data.");
            return;
        }
        ...
        if (authMode === 'signin') {
            ...
            handleError(SocialOAuthErrorCode.GENERAL_ERROR, 'Linking with Farcaster is not supported at the moment.');
        }
        setIsProcessing(false);
    });
    return {
