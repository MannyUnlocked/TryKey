...
const OnboardingUserDataForm = ({ children, userProfile, disableSubmit, }) => {
    ...
    const onSubmit = useCallback((formValues) => __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b;
        const { isEmailVerificationRequired, missingFields, isSmsVerificationRequired, } = yield updateUser(formValues);
        if (isEmailVerificationRequired &&
            ...
            missingFields.map((field) => field.name).toString() === 'phoneNumber') {
            setView('verify-sms');
            return;
        }
