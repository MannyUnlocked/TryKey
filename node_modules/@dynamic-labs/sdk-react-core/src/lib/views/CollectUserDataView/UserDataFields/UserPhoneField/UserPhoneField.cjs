...
const UserPhoneField = ({ onChange, value: phone, onBlur, disabled, label, required, error, name, }) => {
    ...
    return (jsxRuntime.jsx(PhoneNumberField.PhoneNumberField, { initialPhone: phone, disabled: disabled, onUpdate: handleUpdate, onBlur: onBlur, label: label, appendRight: !disabled && !required ? (jsxRuntime.jsx(Typography.Typography, { variant: 'body_small', color: 'secondary', className: 'user-data-fields__phone-number__optional-label', children: "Optional" })) : undefined, error: error }));
};
