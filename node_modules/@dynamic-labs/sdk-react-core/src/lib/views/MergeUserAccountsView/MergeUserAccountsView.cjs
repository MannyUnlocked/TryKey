...
var updateJWTAndCreateUserProfile = require('../../utils/functions/updateJWTAndCreateUserProfile/updateJWTAndCreateUserProfile.cjs');
...
const MergeUserAccountsView = () => {
    ...
    const handleMergeUserAccounts = () => _tslib.__awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            if (newJwt) {
                const newUser = updateJWTAndCreateUserProfile.updateJWTAndCreateUserProfile(newJwt);
