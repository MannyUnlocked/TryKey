...
const NetworkNotSupportedSwitchManual = () => {
    var _a, _b;
    const { user, selectedWalletConnector: walletConnector, isFullyConnected, setShowAuthFlow, bridgeChainsToConnect, } = useInternalDynamicContext.useInternalDynamicContext();
