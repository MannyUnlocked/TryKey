...
const PasskeyIntroView = () => {
    var _a, _b;
    const { walletConnectorOptions, environmentId, handleLogOut, onboardingOnlyJwt, projectSettings, } = useInternalDynamicContext.useInternalDynamicContext();
