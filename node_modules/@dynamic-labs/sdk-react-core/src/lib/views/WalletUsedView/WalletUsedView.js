...
import { updateJWTAndCreateUserProfile } from '../../utils/functions/updateJWTAndCreateUserProfile/updateJWTAndCreateUserProfile.js';
...
const WalletUsedView = () => {
    ...
    const handleWalletTransfer = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const userProfile = updateJWTAndCreateUserProfile(jwt);
            updatePrimaryWalletId(walletConnector, userProfile);
            setUser(userProfile);
            setCallback('linkSuccess', {
                walletId: userProfile.lastVerifiedCredentialId,
            });
