...
const SingleWalletButtons = () => {
    ...
    return (jsxs("div", { className: 'single-wallet-buttons', children: [address && (jsx(Button, { dataTestId: 'Copy address', expanded: true, buttonPadding: 'medium', typographyProps: {
