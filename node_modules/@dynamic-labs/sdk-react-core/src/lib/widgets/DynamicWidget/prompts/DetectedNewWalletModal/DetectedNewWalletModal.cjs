...
const DetectedNewWalletContent = () => {
    ...
    return (jsxRuntime.jsxs("div", { className: 'detected-new-wallet-modal__content', children: [jsxRuntime.jsx(Typography.Typography, { variant: 'body_normal', color: 'primary', children: t('dyn_detected_new_wallet.title') }), jsxRuntime.jsx(promptAccountSwitch.ReactComponent, {}), jsxRuntime.jsx(Typography.Typography, { variant: 'body_small', color: 'secondary', children: t('dyn_detected_new_wallet.description', {
                    walletName: primaryWallet === null || primaryWallet === void 0 ? void 0 : primaryWallet.connector.name,
                }) }), jsxRuntime.jsx(Button.Button, { expanded: true, onClick: handleClick, typographyProps: {
