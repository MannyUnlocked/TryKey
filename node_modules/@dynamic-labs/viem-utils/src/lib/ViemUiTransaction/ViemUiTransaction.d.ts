import { Address, PublicClient, TransactionSerializable } from 'viem';
import { IUITransaction } from '@dynamic-labs/types';
import { Eip1559FeeFeed } from '../utils/Eip1559FeeFeed';
type ViemUiTransactionProps = {
    account: Address;
    transaction: TransactionSerializable;
    onSubmit: (transaction: TransactionSerializable) => Promise<string>;
    publicClient: PublicClient;
};
export declare class ViemUiTransaction extends Eip1559FeeFeed implements IUITransaction {
    chain: string;
